...
export const fetchTransactionsBySeller = createAsyncThunk('transactions/fetchTransactionsBySeller', async (jwt, { rejectWithValue }) => {
  try {
...
export const fetchAllTransactions = createAsyncThunk('transactions/fetchAllTransactions', async (_, { rejectWithValue }) => {
  try {
