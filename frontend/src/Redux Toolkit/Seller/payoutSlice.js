...
export const fetchPayoutsBySeller = createAsyncThunk("payouts/fetchPayoutsBySeller", async (jwt, { rejectWithValue }) => {
  try {
...
export const fetchPayoutById = createAsyncThunk("payouts/fetchPayoutById", async ({ id, jwt }, { rejectWithValue }) => {
  try {
...
export const updatePayoutStatus = createAsyncThunk("payouts/updatePayoutStatus", async ({ id, status }, { rejectWithValue }) => {
  try {
